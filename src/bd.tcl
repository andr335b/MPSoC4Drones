...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net data_copier_0_bram0_dout [get_bd_pins axi_bram_ctrl_0_bram/dinb]
  connect_bd_net -net data_copier_0_bram0_en [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins data_copier_0/bram0_en]
  connect_bd_net -net data_copier_0_bram0_wen [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins data_copier_0/bram0_wen]
  connect_bd_net -net data_copier_0_bram1_addr [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins data_copier_0/bram1_addr]
  connect_bd_net -net data_copier_0_bram1_dout [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins data_copier_0/bram1_dout]
  connect_bd_net -net data_copier_0_bram1_en [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins data_copier_0/bram1_en]
  connect_bd_net -net data_copier_0_bram1_wen [get_bd_pins blk_mem_gen_0/web] [get_bd_pins data_copier_0/bram1_wen]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins data_copier_0/clk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
